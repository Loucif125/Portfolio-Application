 ...
 */
final class Version20200618151624 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity CHANGE name name VARCHAR(255) DEFAULT NULL, CHANGE label label VARCHAR(255) DEFAULT NULL, CHANGE descriprion description VARCHAR(255) DEFAULT NULL, CHANGE global_description global_description VARCHAR(255) DEFAULT NULL, CHANGE sub_global_description sub_global_description VARCHAR(255) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
